...
<head>
	...
	<!-- ini terkoneksi dengan css dari boostrap -->
	<link rel="stylesheet" type="text/css" href="assets/css/bootstrap.min.css">

	<!-- ini terkoneksi dengan js dari boostrap -->
	<script type="assets/js/bootstrap.bundle.js"></script>
...
<body>
	...
	<div class="bg-glases py-5 px-3 col-lg-3">
		...
		<div class="d-flex py-2">
			...
			<div class="col-3 ps-1">
				<button class="btn btn-success col-12" type="submit" name="angka" value="-">-</button>
			</div>
			</div>
			<div class="d-flex py-1">
				<div class="col-3 px-1">
