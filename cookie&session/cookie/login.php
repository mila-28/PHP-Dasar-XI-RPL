...
if (isset($_POST['login'])) {
		...
		if ($username=="admin" && $password=="123") {
			setcookie('login', "login berhasil" , time() + 3600);
...
<body>	
	<div class="container-fluid bg-primry-subtle d-flex align-items-center justify-content-center" style="height: 100vh;">
		...
		<form method="post" action="">
			<input type="text" name="username" class="form-control my-3" placeholder="input username"><input type="password" name="password" class="form-control my-3" placeholder="input password">
